...
import static com.gl.constant.AutoFillConstant.*;
...
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* com.gl.mapper.*.*(..)) && @annotation(com.gl.annotation.AutoFill)")  //指定目录对其进行拦截,对mapper的所有类所有方法。(..)匹配其所有的形参类型。以及加了这个自定义AutoFile注解的进行拦截
