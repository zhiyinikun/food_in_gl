...
import com.gl.interceptor.JwtTokenAdminInterceptor;
import com.gl.interceptor.JwtTokenUserInterceptor;
import com.gl.json.JacksonObjectMapper;
...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    public Docket docket_01() {
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.gl.controller.admin")) //指定扫描包
    ...
    public Docket docket_02() {
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.gl.controller.user")) //指定扫描包
                .paths(PathSelectors.any())
                .build();
        return docket;
    }
