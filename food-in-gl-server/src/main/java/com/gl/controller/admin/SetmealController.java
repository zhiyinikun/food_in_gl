...
import com.gl.dto.CategoryPageQueryDTO;
...
public class SetmealController {
    ...
    @CacheEvict(cacheNames = "SetmealCache",key = "#setmealDTO.categoryId") //指定清理
    ...
    @DeleteMapping
    @ApiOperation("批量删除套餐")
    @CacheEvict(cacheNames = "SetmealCache",allEntries = true) //所以都清理掉
